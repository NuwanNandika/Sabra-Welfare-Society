...
if (isset($_POST['submit'])) {
    ...
    if (empty($username)) {
        ...
        $query = "DELETE FROM register WHERE uname = '$_POST[username]'";
        mysqli_query($conn, $query);
        redirect_to("people.php");
    }
}
?> 
                    ...
                    <div class="jumbotron">
                        ...
                        <form action="delete_user.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="submit" name="submit" class="btn btn-danger" value="Delete User"onclick="return confirm('Are you sure you want to delete this user?');">
                            </div>
                        </form>
                    </div>
                </div>
