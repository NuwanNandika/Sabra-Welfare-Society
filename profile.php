...
$query = "SELECT * FROM register WHERE uname = '$picture'";
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="jumbotron">
                        ...
                        <div id="imgDiv">
                            <img src="<?php echo $admin["picture"]; ?>" id="profilepic" class="img-responsive">
                        </div><br><br><br>
                        <div id="details">
                            <label>Name: </label>
                                <?php echo $admin["FirstName"]." ".$admin["LastName"]; ?><br><br>
                            <label>Address: </label>
                                <?php echo $admin["address"]; ?><br><br>
                            <label>Phone: </label>
                            <?php echo $admin["phone"]; ?><br><br>
                            <label>Email: </label>
                            <?php echo $admin["email"]; ?><br><br>
                            <label>National Identity Card Number: </label>
                            <?php echo $admin["nic"]; ?><br><br>
                            <label>Gender: </label>
                            <?php echo $admin["gender"]; ?><br><br>
                        </div>
                    </div>                   
                </div>
            </div>
